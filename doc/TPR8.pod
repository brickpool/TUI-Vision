...
=head2 TApplication
    ...
    .------------------+-------------------------------------------------------.
    | module           | TUI::App::Application                                  |
    +------------------+-------------------------------------------------------+
    | parents          | TUI::App::Program                                      |
    | classes          | TUI::Views::Group                                      |
    |                  | TUI::Views::View                                       |
    |                  | TUI::Objects::Object                                   |
    |                  | TUI::App::ProgInit                                     |
    +------------------+-------------------------------------------------------+
...
=head2 TBackground
    ...
    .------------------+-------------------------------------------------------.
    | module           | TUI::App::Background                                   |
    +------------------+-------------------------------------------------------+
    | parents          | TUI::Views::View                                       |
    | classes          | TUI::Objects::Object                                   |
    +------------------+-------------------------------------------------------+
    | fields           | pattern                                               |
    +------------------+-------------------------------------------------------+
    | methods          | BUILD()                                               |
...
=head3 Example
  ...
  03  
  04  use 
  05    TUI::Objects; use TUI::App; use TUI::Views;
  06  
  07  { 
...
=head2 TCollection
    ...
    .------------------+-------------------------------------------------------.
    | module           | TUI::Objects::Collection                               |
    +------------------+-------------------------------------------------------+
    | parents          | TUI::Objects::NSCollection                             |
    | classes          | TUI::Objects::Object                                   |
    +------------------+-------------------------------------------------------+
    | fields           | items [TUI::Objects::NSCollection]                     |
    |                  | count [TUI::Objects::NSCollection]                     |
    |                  | limit [TUI::Objects::NSCollection]                     |
    |                  | delta [TUI::Objects::NSCollection]                     |
    |                  | shouldDelete [TUI::Objects::NSCollection]              |
    +------------------+-------------------------------------------------------+
    | methods          | BUILD() [TUI::Objects::NSCollection]                   |
    |                  | BUILDARGS() [TUI::Objects::NSCollection]               |
    |                  | DEMOLISH() [TUI::Objects::NSCollection]                |
    |                  | TCollection()                                         |
    |                  | at() [TUI::Objects::NSCollection]                      |
    |                  | atFree() [TUI::Objects::NSCollection]                  |
    |                  | atInsert() [TUI::Objects::NSCollection]                |
    |                  | atPut() [TUI::Objects::NSCollection]                   |
    |                  | atRemove() [TUI::Objects::NSCollection]                |
    |                  | count() [TUI::Objects::NSCollection]                   |
    |                  | delta() [TUI::Objects::NSCollection]                   |
    |                  | error() [TUI::Objects::NSCollection]                   |
    |                  | firstThat() [TUI::Objects::NSCollection]               |
    |                  | forEach() [TUI::Objects::NSCollection]                 |
    |                  | free() [TUI::Objects::NSCollection]                    |
    |                  | freeAll() [TUI::Objects::NSCollection]                 |
    |                  | from() [TUI::Objects::NSCollection]                    |
    |                  | indexOf() [TUI::Objects::NSCollection]                 |
    |                  | insert() [TUI::Objects::NSCollection]                  |
    |                  | items() [TUI::Objects::NSCollection]                   |
    |                  | lastThat() [TUI::Objects::NSCollection]                |
    |                  | limit() [TUI::Objects::NSCollection]                   |
    |                  | name()                                                |
    |                  | new_TCollection()                                     |
    |                  | pack() [TUI::Objects::NSCollection]                    |
    |                  | remove() [TUI::Objects::NSCollection]                  |
    |                  | removeAll() [TUI::Objects::NSCollection]               |
    |                  | setLimit() [TUI::Objects::NSCollection]                |
    |                  | shouldDelete() [TUI::Objects::NSCollection]            |
    |                  | shutDown() [TUI::Objects::NSCollection]                |
    '------------------+-------------------------------------------------------'
...
=head2 TDeskTop
    ...
    .------------------+-------------------------------------------------------.
    | module           | TUI::App::DeskTop                                      |
    +------------------+-------------------------------------------------------+
    | parents          | TUI::Views::Group                                      |
    |                  | TUI::App::DeskInit                                     |
    | classes          | TUI::Views::View                                       |
    |                  | TUI::Objects::Object                                   |
    +------------------+-------------------------------------------------------+
    | fields           | background                                            |
    |                  | tileColumnsFirst                                      |
